...
public class Creation implements IConstantes {
    ...
    public static boolean base() {
        ...
        try (Connection conn = Connexion.connecterSansBase()) {
            Statement stmt = conn.createStatement();
            
            System.out.println("Creation de la BDD " + NOM_BDD + " si elle n'existe pas.");
    ...
    private static void table(String table) {
        ...
        try {
            ...
            System.out.println("Creation de la table " + table + " si elle n'existe pas.");
