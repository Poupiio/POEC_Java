...
public class ExConditions {
    public static void main(String[] args) {
        ...
        System.out.print("Saisir le numero 1 : ");
        num1 = clavier.nextInt();

        System.out.print("Saisir le numero 2 : ");
        num2 = clavier.nextInt();

        System.out.print("Saisir le numero 3 : ");
        ...
        // Fournir les donnees d'entree
        System.out.println("Saisir le numero du mois (1-12) : ");
